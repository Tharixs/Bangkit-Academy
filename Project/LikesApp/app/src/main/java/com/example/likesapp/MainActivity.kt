...
class MainActivity : AppCompatActivity() {
    ...
    private val halfOfWidth = (mBitmap.width / 2F)
    private val halfOfHeight = (mBitmap.height / 2F)
...
//        get text bounds
    ...
    private fun showHair(){
        ...
        path.addCircle(halfOfWidth -100 , halfOfHeight -10, 150F, Path.Direction.CCW)
        path.addCircle(halfOfWidth +100 , halfOfHeight -10, 150F, Path.Direction.CCW)
