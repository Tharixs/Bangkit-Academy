 ...
 */
class ImageBanWidget : AppWidgetProvider() {
    ...
    companion object {
        ...
        private fun updateAppWidget(
            ...
            val views = RemoteViews(context.packageName, R.layout.image_ban_widget)
            views.setRemoteAdapter(R.id.stackView, intent)
            views.setEmptyView(R.id.stackView, R.id.emptyView)

            val toastIntent = Intent(context, ImageBanWidget::class.java)
